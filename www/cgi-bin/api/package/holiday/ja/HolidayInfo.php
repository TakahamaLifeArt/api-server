 ...
 * @version 2.1
 * 
 * log	2016-06-14: 山の日を追加。2016年から8月11日を祝日とする
 * 		2016-08-11: 旧暦取得の判別を更新
 *		2017-04-24: 旧暦判別を廃止
 */

namespace package\holiday\ja;
...
//		$this->lc = new $lc();
	 ...
	 * @param int $time_stamp タイムスタンプ
	 */
	public function getYear($time_stamp)
	{
	 ...
	 * @param int $time_stamp タイムスタンプ
	 */
	public function getDay($time_stamp)
	{
	 ...
	 * @param int $time_stamp タイムスタンプ
	 */
	public function getStrDay($time_stamp)
	{
	 ...
	 * @return array
	 */
	public function getJanuaryHoliday($year)
	{
	 ...
	 * @return array
	 */
	public function getFebruaryHoliday($year)
	{
	 ...
	 * @return array
	 */
	public function getMarchHoliday($year)
	{
	 ...
	 * @return array
	 */
	public function getAprilHoliday($year)
	{
		if ($year == 1959) {
	 ...
	 * @return array
	 */
	public function getMayHoliday($year)
	{
	 ...
	 * @return array
	 */
	public function getJuneHoliday($year)
	{
		if ($year == "1993") {
	 ...
	 * @param boolean $luna 旧暦情報を使用する場合はtrue(falseにすると、旧暦情報を取得しない代わりに、より、高速に動作します)
	 ...
	 * @return array
	 */
	public function getWorkingDay($time_stamp, $lim_day, $luna = false, $is_bypass_holiday = true, $bypass_week_arr = false, $is_bypass_date = false )
	{
	 ...
	 * @return array
	 */
	public function getJulyHoliday($year)
	{
		if ($year >= 2003) {
	 ...
	 * @return array
	 */
	public function getAugustHoliday($year)
	{
		if ($year >= 2016) {
	 ...
	 * @return array
	 */
	public function getSeptemberHoliday($year)
	{
	 ...
	 * @return array
	 */
	public function getOctoberHoliday($year)
	{
		if ($year >= 2000) {
			//2000年以降は第二月曜日に変更
	 ...
	 * @return array
	 */
	public function getNovemberHoliday($year)
	{
	 ...
	 * @return array
	 */
	public function getDecemberHoliday($year)
	{
		if ($year >= 1989) {
	 ...
	 * @param boolean $luna 旧暦情報を使用する場合はtrue(falseにすると、旧暦情報を取得しない代わりに、より、高速に動作します)
	 */
	public function getCalendar($year, $month, $luna = false)
	{
	 ...
	 * @param boolean $luna 旧暦情報を使用する場合はtrue(falseにすると、旧暦情報を取得しない代わりに、より、高速に動作します)
	 */
	public function getSpanCalendar($year, $month, $str, $lim, $luna = false)
	{
		if ($lim <= 0) {
			return array();
		}
...
//			}
	 ...
	 *
	 * @param int $time_stamp タイムスタンプ
	 * @param boolean $luna 旧暦情報を使用する場合はtrue(falseにすると、旧暦情報を取得しない代わりに、より高速に動作します)
	 * @return array
	 */
	public function purseTime($time_stamp, $luna = false)
	{
...
//		}
	 ...
	 * @return array
	 *
	public function getLunaCalendarList($time_stamp_array, $mode = JD_KEY_ORDERD)
	{
	 ...
	 * @return array
	 *
	public function getTuitachiArray($time_stamp)
	{
	 ...
	 * @
	 */
	public function mb_strftime($format, $time_stamp = false, $luna = false)
	{
		if ($time_stamp === false) {
			$time_stamp = time();
		}
